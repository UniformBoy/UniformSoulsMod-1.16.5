...
public class JusticeBulletEntity extends ThrownEntity {
    ...
    public JusticeBulletEntity(EntityType<? extends JusticeBulletEntity> entityType, World world) {
        super(entityType, world);
    }

    @Environment(EnvType.CLIENT)
    public JusticeBulletEntity(World world, double x, double y, double z, int id, UUID uuid) {
        super(UniformSouls.JUSTICE_BULLET_ENTITY, world);
        setPosition(x, y, z);
    ...
    public void onEntityHit(EntityHitResult entityHitResult) {
        if (!this.world.isClient) {
            ...
            if (entity2 instanceof LivingEntity) {
                ...
                bl2 = entity.damage(UniformSouls.JUSTICE_BULLET_DAMAGE, 5.0F);
                if (bl2) {
                    if (entity.isAlive()) {
    ...
    public void onCollision(HitResult hitResult) {
        ...
        if (hitResult.getType() != HitResult.Type.ENTITY || !((EntityHitResult)hitResult).getEntity().isPartOf(entity)) {
            if (!this.world.isClient) {
                ...
                areaEffectCloudEntity.setParticleType(UniformSouls.SOUL_JUSTICE);
                ...
                world.addParticle(UniformSouls.FLASH_YELLOW, this.getX(), this.getY(), this.getZ(), 0.0D, 0.0D, 0.0D);
                this.remove();
            }

...
package com.uniform.uniformsouls.entity;
...
public abstract class UniTameableEntity extends AnimalEntity {
    protected static final TrackedData<Byte> TAMEABLE_FLAGS;
    protected static final TrackedData<Optional<UUID>> OWNER_UUID;
    private boolean sitting;

    protected UniTameableEntity(EntityType<? extends UniTameableEntity> entityType, World world) {
    ...
    public void readCustomDataFromNbt(NbtCompound tag) {
        ...
        this.isInSneakingPose(this.sitting);
    }

    protected abstract void isInSneakingPose(boolean sitting);
    ...
    static {
        TAMEABLE_FLAGS = DataTracker.registerData(UniTameableEntity.class, TrackedDataHandlerRegistry.BYTE);
        OWNER_UUID = DataTracker.registerData(UniTameableEntity.class, TrackedDataHandlerRegistry.OPTIONAL_UUID);
    }
}

...
public class PureEnchantment extends Enchantment {

    public PureEnchantment() {
    ...
    public static boolean hasPure(LivingEntity entity) {
        return getEquipmentLevel(UniformSouls.PURE, entity) > 0;
    }

...
public class KindnessShieldEntity extends ThrownEntity implements DefaultSoulProjectile {
    ...
    public KindnessShieldEntity(EntityType<? extends KindnessShieldEntity> entityType, World world) {
        super(entityType, world);
    }

    @Environment(EnvType.CLIENT)
    public KindnessShieldEntity(World world, double x, double y, double z, int id, UUID uuid) {
        super(UniformSouls.KINDNESS_SHIELD_ENTITY, world);
        setPosition(x, y, z);
    ...
    public void onEntityHit(EntityHitResult entityHitResult) {
        if (!this.world.isClient) {
            ...
            if (entity2 instanceof LivingEntity) {
                ...
                bl2 = entity.damage(UniformSouls.KINDNESS_PAN_DAMAGE, 5.0F);
                if (bl2) {
                    if (entity.isAlive()) {

...
import com.uniform.uniformsouls.entity.model.UniCartDefaultEntityModel;
...
public class UniCartDefaultEntityRenderer<T extends UniCartDefault> extends EntityRenderer<T> {
    private static final Identifier TEXTURE = new Identifier("uniformsouls", "textures/entity/unicartdefault/unicartdefault.png");
    public final EntityModel<T> model = new MinecartEntityModel();

    public UniCartDefaultEntityRenderer(EntityRenderDispatcher entityRenderDispatcher) {

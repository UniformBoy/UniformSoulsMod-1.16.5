...
public class PatienceStringEntityModel extends EntityModel<PatienceStringEntity> {
private final ModelPart bb_main;
	private final ModelPart cube_r1;
	private final ModelPart cube_r2;
public PatienceStringEntityModel() {
		textureWidth = 64;
		textureHeight = 64;
...
@Override
public void setAngles(PatienceStringEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){

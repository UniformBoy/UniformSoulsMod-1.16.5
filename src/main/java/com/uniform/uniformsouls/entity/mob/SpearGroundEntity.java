...
public class SpearGroundEntity extends PathAwareEntity {
    ...
    public SpearGroundEntity(EntityType<? extends PathAwareEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createspeargroundAttributes() {

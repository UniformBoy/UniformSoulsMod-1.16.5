...
public class HateEntity extends ZombieEntity {

    public boolean ZombieCanSpawn = true;

    public HateEntity(EntityType<? extends ZombieEntity> entityType, World world) {
    ...
    public void playAmbientSound() {
        this.playSound(this.getAmbientSound(), 0.5F, 0.8F);
    }
    ...
    public static DefaultAttributeContainer.Builder createhateAttributes() {

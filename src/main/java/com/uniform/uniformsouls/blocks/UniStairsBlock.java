...
public class UniStairsBlock extends StairsBlock {
    ...
    public UniStairsBlock(BlockState baseBlockState, Settings settings) {
    ...
    static {
        ...
        TOP_SHAPE = UniSlabBlock.TOP_SHAPE;
        BOTTOM_SHAPE = UniSlabBlock.BOTTOM_SHAPE;

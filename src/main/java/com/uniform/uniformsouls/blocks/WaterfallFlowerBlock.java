...
public class WaterfallFlowerBlock extends WaterfallPlantBlock {
    ...
    public WaterfallFlowerBlock(StatusEffect suspiciousStewEffect, int effectDuration, Settings settings) {
        super(settings);

...
public class EmptyIntegritySoul extends Item {

    public EmptyIntegritySoul(Settings settings) {
        super(settings);
    }
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("You Are Filled With Emptiness").formatted(Formatting.DARK_BLUE));

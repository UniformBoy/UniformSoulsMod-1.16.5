...
public class PatienceSoul extends Item {
    ...
    public PatienceSoul(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if (!playerEntity.isSneaking()) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.PATIENCE_TOY_KNIFE);
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("You Are Filled With Patience").formatted(Formatting.AQUA));

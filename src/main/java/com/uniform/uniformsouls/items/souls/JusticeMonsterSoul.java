...
public class JusticeMonsterSoul extends Item {

    public JusticeMonsterSoul(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if (!playerEntity.isSneaking()) {
            ...
            return TypedActionResult.success(playerEntity.getStackInHand(hand));
                ...
                ItemStack itemStack = new ItemStack(ModItems.EMPTY_GUN);
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("The Soul Of A Monster").formatted(Formatting.WHITE));

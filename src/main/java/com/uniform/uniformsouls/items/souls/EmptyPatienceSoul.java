...
public class EmptyPatienceSoul extends Item {

    public EmptyPatienceSoul(Settings settings) {
        super(settings);
    }
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("You Are Filled With Emptiness").formatted(Formatting.AQUA));

...
public class EmptyPerseveranceSoul extends Item {

    public EmptyPerseveranceSoul(Settings settings) {
        super(settings);
    }
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("You Are Filled With Emptiness").formatted(Formatting.DARK_PURPLE));

...
public class BraverySoul extends Item {

    public BraverySoul(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if (!playerEntity.isSneaking()) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.BRAVERY_TOUGH_GLOVE);
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("You Are Filled With Bravery").formatted(Formatting.GOLD));

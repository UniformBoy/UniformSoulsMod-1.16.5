...
public class EmptyJusticeSoul extends Item {

    public EmptyJusticeSoul(Settings settings) {
        super(settings);
    }
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("You Are Filled With Emptiness").formatted(Formatting.YELLOW));

...
public class EmptyDeterminationSoul extends Item {

    public EmptyDeterminationSoul(Settings settings) {
        super(settings);
    }
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("You Are Filled With Hopelessness").formatted(Formatting.DARK_RED));

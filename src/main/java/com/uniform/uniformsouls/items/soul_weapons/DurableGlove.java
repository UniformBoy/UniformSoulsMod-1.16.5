...
public class DurableGlove extends SwordItem {

    public DurableGlove(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand){
        if (!playerEntity.isSneaking()) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.BRAVERY_MONSTER_SOUL);

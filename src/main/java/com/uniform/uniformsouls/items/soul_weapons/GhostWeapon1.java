...
public class GhostWeapon1 extends SwordItem {

    public GhostWeapon1(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!user.isSneaking()) {
            ...
            if (!world.isClient) {
                GhostProjEntity proj = new GhostProjEntity(UniformSouls.GHOST_PROJ_ENTITY, world);
            ...
            ItemStack itemStack = new ItemStack(ModItems.GHOST_MONSTER_SOUL);

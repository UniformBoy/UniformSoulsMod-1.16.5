...
public class SkeletonBone1 extends SwordItem {

    public SkeletonBone1(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!user.isSneaking()) {
            ...
            if (!world.isClient) {
                BoneProjEntity proj = new BoneProjEntity(UniformSouls.BONE_PROJ_ENTITY, world);

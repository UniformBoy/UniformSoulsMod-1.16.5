...
public class DeterminationKnife extends SwordItem {

    public DeterminationKnife(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {

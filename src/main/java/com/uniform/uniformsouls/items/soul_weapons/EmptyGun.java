...
public class EmptyGun extends SwordItem {

    public EmptyGun(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand){
        if (!playerEntity.isSneaking()) {
            ...
            ItemStack itemStack = new ItemStack(ModItems.JUSTICE_MONSTER_SOUL);

...
public class IntegritySoul extends Item {
    ...
    public IntegritySoul(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if (!playerEntity.isSneaking()) {
            ...
            playerEntity.addStatusEffect(new StatusEffectInstance(UniformSouls.INTEGRITYEFFECT1, 600, 4, false, false, false));
            playerEntity.incrementStat(Stats.USED.getOrCreateStat(this));

            return TypedActionResult.success(playerEntity.getStackInHand(hand));
        } else {
            ItemStack itemStack = new ItemStack(ModItems.INTEGRITY_BALLET_SHOES);
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("You Are Filled With Integrity").formatted(Formatting.DARK_BLUE));

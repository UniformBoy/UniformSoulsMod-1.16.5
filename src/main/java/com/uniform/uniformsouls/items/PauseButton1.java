...
public class PauseButton1 extends Item {

    public PauseButton1(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand){
        ...
        playerEntity.playSound(UniformSouls.UNDERTALE_INTRO_SOUND_1_EVENT, 2.0F, 1.5F);
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("Pauses The Game").formatted(Formatting.GOLD));

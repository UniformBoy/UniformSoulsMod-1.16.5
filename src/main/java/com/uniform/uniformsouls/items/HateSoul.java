...
public class HateSoul extends Item {

    public HateSoul(Settings settings) {
        super(settings);
    }
    ...
    {
        //Basic Info
        tooltip.add(new TranslatableText("You Are Filled With Hate").formatted(Formatting.BLACK));
